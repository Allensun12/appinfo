				...
				<div class="row">
					<div class="col-sm-12">
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<tbody>
								<c:forEach var="appInfo" items="${requestScope.map.appInfoList}" varStatus="status">
									<tr role="row" class="odd">
										<td tabindex="0" class="sorting_1">${appInfo.softwareName}</td>
										<td>${appInfo.apkName }</td>
										<td>${appInfo.softwareSize }</td>
										<td>${appInfo.appFlatform.valueName }</td>
										<td>${appInfo.appCategoryLevel1.categoryName } -> ${appInfo.appCategoryLevel2.categoryName } -> ${appInfo.appCategoryLevel3.categoryName }</td>
										<td>${appInfo.appStatus.valueName}</td>
										...
										<button type="button" class="btn btn-default checkApp"
											...
											statusname="${appInfo.appStatus.valueName}"
